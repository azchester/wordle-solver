...
test("common set is official NYT answer list", function () {
  assert.strictEqual(common.COMMON_WORDS.length, 2447);
  ...
  assert.ok(COMMON_SET.BEIGE); // NYT #1905, 2026-09-06
  assert.ok(COMMON_SET.LIVEN); // NYT #1907, 2026-09-08
  assert.ok(COMMON_SET.NIFTY); // NYT #1911, 2026-09-12
  assert.ok(COMMON_SET.WAKEN); // NYT #1918, 2026-09-19
  assert.ok(COMMON_SET.PAGER); // NYT #1920, 2026-09-21
...
test("NYT-added answers that were only on the allowed-guess list are categorized as answers", function () {
  var added = [
    ...
    "BLING", "LATKE", "ADIEU", "UMAMI", "MOCHI", "HAIKU", "OKAPI", "RUNNY", "CAPON", "TWEEN", "INTEL", "SOUPY", "BEIGE", "LIVEN", "NIFTY", "WAKEN", "PAGER", "MESSY"
  ];
